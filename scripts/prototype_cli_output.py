"""PROTOTYPE — throwaway. Prints mocked CLI output for the Income Tax Q&A agent
...
{SEPARATOR}
⚠ תשובה לא ודאית (התאמה חלקית, 61%) — הפקודה מתייחסת לניכוי
...
מקורות (התאמה):
  [1] סעיף 32(1)(א)  (61%) — "הוצאות שהוצאו לשם ייצור הכנסה
...
הסעיפים הקרובים ביותר שנבדקו, ולא עברו את סף ההתאמה (35%):
  - סעיף 15  (22%) — עוסק בניכוי מס במקור, לא במע"מ.
  - סעיף 3   (19%) — הגדרת "הכנסה חייבת".
{SEPARATOR}
"""
